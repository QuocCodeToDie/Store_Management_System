...
import login.login;
import bill_detail.bill_detail;
import javax.swing.*;
...
public class MainForm extends JFrame{
    ...
    private JTable getAlllProductTable;
    private JLabel print_billButton;
    private JPanel billDetailPanel;
    private JButton Button2;
    private JTextArea textArea2;
    private JTable orderTable_Data;
    private Boolean isRegister = false;

    private ArrayList<bill_detail> bill_result_final = new ArrayList<>();
    private int bill_id_result = 0;
    ...
    public MainForm(String title) throws IOException, SQLException {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if(log_overall.checkloginInfo(id,password)){
                        ...
                        ImageIcon icon = new ImageIcon("G:\\DO AN JAVA 15.05.2021\\src\\resources\\images\\home-on.PNG");
                        Home.setIcon(icon);
                        ImageIcon icon2 = new ImageIcon("G:\\DO AN JAVA 15.05.2021\\src\\resources\\images\\find-on.PNG");
                        Search.setIcon(icon2);
                        ImageIcon icon3 = new ImageIcon("G:\\DO AN JAVA 15.05.2021\\src\\resources\\images\\setting-on.PNG");
                        Fix.setIcon(icon3);
                        ImageIcon icon4 = new ImageIcon("G:\\DO AN JAVA 15.05.2021\\src\\resources\\images\\logout-on.PNG");
                        logout.setIcon(icon4);
                        ImageIcon icon5 = new ImageIcon("G:\\DO AN JAVA 15.05.2021\\src\\resources\\images\\exit-on.PNG");
                        exit.setIcon(icon5);
        ...
        employeeData.setModel(new DefaultTableModel(data,new String[]{"ID", "Tên",  "Số điện thoại", "Địa Chỉ", "Ngày sinh", "Giới tính", "Lương", "Loại nhân viên", "ID Cửa hàng"})
        );

        Product prd1 = new Product();
        Object[][] data1=prd1.getList();
        productData.setModel(new DefaultTableModel(data1,new String[]{"ID sản phẩm", "Tên sản phẩm",  "Loại sản phẩm", "Mô tả", "Ngày sản xuất", "Hạn sử dụng", "Giá", "Id cửa hàng", "Số lượng"})
        );

        Customer cus1 = new Customer();
        Object[][] data2 = cus1.getList();
        customerData.setModel(new DefaultTableModel(data2, new String[]{"ID khách háng","Địa chỉ","Số điện thoại","Họ và tên","Id cửa hàng"}));

        Bill bill1 = new Bill();
        Object[][] data3 = bill1.getList();
        billData.setModel(new DefaultTableModel(data3, new String[]{"ID Bill","ID nhân viên","ID khách hàng","Ngày tạo bill","Tổng tiền"}));
//        billData.setModel(new DefaultTableModel(data3, new String[]{"ID Bill","ID NV","ID KH","DATE","sum"}));
//        JTableHeader h1 = new JTableHeader(new String[]{"ID Bill","ID NV","ID KH","DATE","sum"});
//        billData.setTableHeader();
        ...
        querybillButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    orderData.setModel(new DefaultTableModel(data4, new String[]{"ID Order","ID sản phẩm","Số lượng sản phẩm","Ngày xuất order","ID bill","Tổng tiền"}));
        ...
        findButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    if(data_in.length!=0)
                        search_result.setModel(new DefaultTableModel(data_in, new String[]{"ID sản phẩm", "Tên sản phẩm",  "Loại sản phẩm", "Mô tả", "Ngày sản xuất", "Hạn sử dụng", "Giá", "Id cửa hàng", "Số lượng"}));
                    else{
        ...
        button1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    Object[][] data_in = tmp_emp_2.getEmployeeByOptions(Integer.parseInt(idnvInput.getText()),namenvInput.getText(),Integer.parseInt(paynvInput.getText()));
                    if(data_in.length!=0)
                        search_result.setModel(new DefaultTableModel(data_in, new String[]{"ID", "Tên",  "Số điện thoại", "Địa Chỉ", "Ngày sinh", "Giới tính", "Lương", "Loại nhân viên", "ID Cửa hàng"}));
                    else{
        ...
        customer_find_Button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    if(data_in.length!=0)
                        search_result.setModel(new DefaultTableModel(data_in, new String[]{"ID khách háng","Địa chỉ","Số điện thoại","Họ và tên","Id cửa hàng"}));
                    else{
        ...
        search_bill_Button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    if(data_in.length!=0)
                        search_result.setModel(new DefaultTableModel(data_in, new String[]{"ID Bill","ID nhân viên","ID khách hàng","Ngày tạo bill","Tổng tiền"}));
                    else{
        ...
        search_order_Button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    if(data_in.length!=0)
                        search_result.setModel(new DefaultTableModel(data_in, new String[]{"ID Order","ID sản phẩm","Số lượng sản phẩm","Ngày xuất order","ID bill","Tổng tiền"}));
                    else{
...
//        });
        ...
        regButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                int type_em = 0;
                if(comboBox1.getSelectedItem().toString().equals("Nhân viên thường")) type_em = 1;
                else if(comboBox1.getSelectedItem().toString().equals("Nhân viên quản lý")) type_em = 2;
                else type_em = 3;
                try {
                    ...
                    if(curr_index==0){
                        if(curr_user_type==4) {
                            ...
                            try {
                                ...
                                if(data_in.length!=0)
                                    delete_List.setModel(new DefaultTableModel(data_in,new String[]{"ID", "Tên",  "Số điện thoại", "Địa Chỉ", "Ngày sinh", "Giới tính", "Lương", "Loại nhân viên", "ID Cửa hàng"}));
                                else{
                                    JOptionPane.showMessageDialog(null,"Nhân viên không tồn tại!");
                                }
                            } catch (SQLException throwables) {
                        ...
                        try {
                            ...
                            if(data_in.length!=0)
                                delete_List.setModel(new DefaultTableModel(data_in, new String[]{"ID khách háng","Địa chỉ","Số điện thoại","Họ và tên","Id cửa hàng"}));
                            else{
                                JOptionPane.showMessageDialog(null,"Khách hàng không tồn tại!");
                            }
                        } catch (SQLException throwables) {
                        ...
                        try {
                            Object[][] data_in = cus1.getList();
                            if(data_in.length!=0)
                                delete_List.setModel(new DefaultTableModel(data_in, new String[]{"ID sản phẩm", "Tên sản phẩm",  "Loại sản phẩm", "Mô tả", "Ngày sản xuất", "Hạn sử dụng", "Giá", "Id cửa hàng", "Số lượng"}));
                            else{
                                JOptionPane.showMessageDialog(null,"Sản phẩm không tồn tại!");
                            }
                        } catch (SQLException throwables) {
                        ...
                        try {
                            Object[][] data_in = cus1.getList();
                            if(data_in.length!=0)
                                delete_List.setModel(new DefaultTableModel(data_in, new String[]{"ID Bill","ID nhân viên","ID khách hàng","Ngày tạo bill","Tổng tiền"}));
                            else{
                                JOptionPane.showMessageDialog(null,"Bill không tồn tại!");
                            }
                        } catch (SQLException throwables) {
                        ...
                        try {
                            Object[][] data_in = cus1.getList();
                            if(data_in.length!=0)
                                delete_List.setModel(new DefaultTableModel(data_in, new String[]{"ID Order","ID sản phẩm","Số lượng sản phẩm","Ngày xuất order","ID bill","Tổng tiền"}));
                            else{
                                JOptionPane.showMessageDialog(null,"Bill không tồn tại!");
                            }
                        } catch (SQLException throwables) {
        ...
        update_nv_Button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(textField17.getText()!=null&&textField18.getText()!=null&&textField19.getText()!=null&&textField20.getText()!=null&&textField21.getText()!=null&&textField22.getText()!=null&&textField23.getText()!=null){
                    try {
                        tmp_emp_2.updateEmployeeByOptions(Integer.parseInt(textField17.getText()),textField18.getText(),textField19.getText(),textField23.getText(),tmp,textField21.getText(),Integer.parseInt(textField22.getText()));
...
//                Employee tmp_emp_2 = new Employee();
                    try {
                        ...
                        if(data_in.length!=0)
                            update_nv_Table.setModel(new DefaultTableModel(data_in, new String[]{"ID", "Tên",  "Số điện thoại", "Địa Chỉ", "Ngày sinh", "Giới tính", "Lương", "Loại nhân viên", "ID Cửa hàng"}));
                        else{
                            JOptionPane.showMessageDialog(null,"Nhân viên không tồn tại!");
                        }
                    } catch (SQLException throwables) {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(name!=null&&sdt!=null&&diachi!=null){
                    ...
                    try {
                        ...
                        if(data_in.length!=0)
                            update_nv_Table.setModel(new DefaultTableModel(data_in, new String[]{"ID khách hàng","Địa chỉ","Số điện thoại","Họ và tên","Id cửa hàng"}));
                        else{
                            JOptionPane.showMessageDialog(null,"khách hàng không tồn tại!");
                        }
                    } catch (SQLException throwables) {
        ...
        update_order_Button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    if(data_in.length!=0)
                        update_nv_Table.setModel(new DefaultTableModel(data_in, new String[]{"ID Order","ID sản phẩm","Số lượng sản phẩm","Ngày xuất order","ID bill","Tổng tiền"}));
                    else{
                        JOptionPane.showMessageDialog(null,"Order không tồn tại!");
                    }
                } catch (SQLException throwables) {
        ...
        create_OrderButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(!textField11.getText().equals("")){
                    try {
                        if(ord1.checkIDExist(textField11.getText())){
                        ...
                        textField33.setVisible(true);
                                ...
                                try {
                                    Product tmp_prd1 = new Product();
                                    Object[][] data1=tmp_prd1.getListWithOptions();
                                    getAlllProductTable.setModel(new DefaultTableModel(data1,new String[]{"ID sản phẩm", "Tên sản phẩm",   "Giá",  "Số lượng"}));

//                                    Order ord12 = new Order();
//                                    Object[][] data23=ord12.getList();
//                                    orderTable_Data.setModel(new DefaultTableModel(data23,new String[]{"ID Order", "ID sản phẩm", "Số lượng","Ngày order","ID bill","Tổng tiền"}));
                                } catch (SQLException throwables) {
                                    throwables.printStackTrace();
                                }
                            }
        ...
        execute_Button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                print_billButton.setVisible(true);
                try {
                    ...
                    //int bill_id = cst2.getBill_id();
                    bill_id_result = cst2.getBill_id();
                    System.out.println("809 "+bill_id_result);
                    ...
                    Bill b1 = new Bill();
                    bill_result_final.add(b1.inCTBill(bill_id_result)) ;
                    Object[][] data23 = new Object[bill_result_final.size()][];
                    for (int i = 0; i < bill_result_final.size(); i++) {
                        data23[i]= new Object[]{bill_result_final.get(i).getId_sp(),bill_result_final.get(i).getSp_name(), bill_result_final.get(i).getSoluong(),bill_result_final.get(i).getTongtien()};
                    }
                    orderTable_Data.setModel(new DefaultTableModel(data23,new String[]{"ID sản phẩm", "Tên sản phẩm", "Số lượng","Tổng tiền"}));
        ...
        //TODO: in chi tiet bill:
        print_billButton.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                super.mouseClicked(e);
                textArea2.setText("");
                ...
                String em_name = "";
                try {
                    em_name = e1.geteNameByID(bill_result_final.get(0).getId_nv());
                } catch (SQLException throwables) {
                    throwables.printStackTrace();
                }
                String res_info = "";
                for (int i = 0; i < bill_result_final.size(); i++) {
                    res_info+=bill_result_final.get(i).getSp_name()+"\t"+bill_result_final.get(i).getSoluong()+"\t"+bill_result_final.get(i).getDongia()+"\t"+bill_result_final.get(i).getTongtien()+"\n";
                }
                textArea2.append("Ministore \n"+"Bill id: "+bill_id_result+"\nTên nhân viên: "+em_name+"\nID nhân viên: "+bill_result_final.get(0).getId_nv()+"\nNgày tạo bill: "+bill_result_final.get(0).getDate()+"\nTên hàng\tSố lượng\tĐơn giá\tThành tiền \n"+res_info+"\nId khách hàng: "+bill_result_final.get(0).getId_kh());
                cl.show(MidPanel,"Card10");
    ...
    public static void main(String[] args) throws IOException, SQLException {
        JFrame frame = new MainForm("Ministore");
